    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="sr-only">Space Bowling Greece - Full cosmic bowling gallery images</span>
        </motion.div>
        ...
        >
          {images.map((img, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex justify-center items-center">
