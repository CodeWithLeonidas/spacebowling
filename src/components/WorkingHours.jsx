...
export default function WorkingHours() {
  ...
  return (
    <section id="working-hours" className="py-16 bg-gray-900 text-white">
      <div className="container mx-auto flex flex-col lg:flex-row-reverse items-center gap-12 px-6 ">
        {/* Right Side - Working Hours Card */}
        <motion.div
              ...
              <ul className="space-y-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-lg text-gray-300 font-medium">18:00 - 02:00</span>
                  </motion.li>
                ))}
              </ul>
            </div>
